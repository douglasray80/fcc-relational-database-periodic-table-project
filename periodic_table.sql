...
INSERT INTO public.properties VALUES (9, 18.998000, -220, -188.1, 3);
INSERT INTO public.properties VALUES (10, 20.18000, -248.6, -246.1, 3);
...
UPDATE ONLY public.properties
    SET atomic_mass=trim(trailing '00' FROM atomic_mass::TEXT)::DECIMAL;
